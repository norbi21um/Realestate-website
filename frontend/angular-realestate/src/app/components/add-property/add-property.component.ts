...
export class AddPropertyComponent implements OnInit {
  ...
  onSubmit() {
    ...
    propertyItem.description = this.addNewFormGroup.get(
      'property.description'
    ).value;
    propertyItem.district = this.addNewFormGroup.get('property.district').value;
    ...
    if (this.addNewFormGroup.get('property.imageUrl').value == '') {
      ...
      propertyItem.imageUrl =
        this.addNewFormGroup.get('property.imageUrl').value;
    }
